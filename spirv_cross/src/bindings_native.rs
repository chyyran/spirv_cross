...
pub mod root {
    ...
    pub mod spv {
        ...
        pub const ExecutionMode_ExecutionModeSubgroupUniformControlFlowKHR:
            root::spv::ExecutionMode = 4421;
        ...
        pub const ExecutionMode_ExecutionModeEarlyAndLateFragmentTestsAMD:
            root::spv::ExecutionMode = 5017;
        pub const ExecutionMode_ExecutionModeStencilRefReplacingEXT: root::spv::ExecutionMode =
            5027;
        pub const ExecutionMode_ExecutionModeStencilRefUnchangedFrontAMD: root::spv::ExecutionMode =
            5079;
        pub const ExecutionMode_ExecutionModeStencilRefGreaterFrontAMD: root::spv::ExecutionMode =
            5080;
        pub const ExecutionMode_ExecutionModeStencilRefLessFrontAMD: root::spv::ExecutionMode =
            5081;
        pub const ExecutionMode_ExecutionModeStencilRefUnchangedBackAMD: root::spv::ExecutionMode =
            5082;
        pub const ExecutionMode_ExecutionModeStencilRefGreaterBackAMD: root::spv::ExecutionMode =
            5083;
        pub const ExecutionMode_ExecutionModeStencilRefLessBackAMD: root::spv::ExecutionMode = 5084;
        pub const ExecutionMode_ExecutionModeOutputLinesEXT: root::spv::ExecutionMode = 5269;
        pub const ExecutionMode_ExecutionModeOutputLinesNV: root::spv::ExecutionMode = 5269;
        pub const ExecutionMode_ExecutionModeOutputPrimitivesEXT: root::spv::ExecutionMode = 5270;
        ...
        pub const ExecutionMode_ExecutionModeDerivativeGroupLinearNV: root::spv::ExecutionMode =
            5290;
        pub const ExecutionMode_ExecutionModeOutputTrianglesEXT: root::spv::ExecutionMode = 5298;
        ...
        pub const ExecutionMode_ExecutionModeSharedLocalMemorySizeINTEL: root::spv::ExecutionMode =
            5618;
        pub const ExecutionMode_ExecutionModeRoundingModeRTPINTEL: root::spv::ExecutionMode = 5620;
        pub const ExecutionMode_ExecutionModeRoundingModeRTNINTEL: root::spv::ExecutionMode = 5621;
        pub const ExecutionMode_ExecutionModeFloatingPointModeALTINTEL: root::spv::ExecutionMode =
            5622;
        pub const ExecutionMode_ExecutionModeFloatingPointModeIEEEINTEL: root::spv::ExecutionMode =
            5623;
        ...
        pub const ExecutionMode_ExecutionModeSchedulerTargetFmaxMhzINTEL: root::spv::ExecutionMode =
            5903;
        ...
        pub const ImageOperandsShift_ImageOperandsZeroExtendShift: root::spv::ImageOperandsShift =
            13;
        pub const ImageOperandsShift_ImageOperandsNontemporalShift: root::spv::ImageOperandsShift =
            14;
        ...
        pub const FPFastMathModeShift_FPFastMathModeAllowContractFastINTELShift:
            root::spv::FPFastMathModeShift = 16;
        pub const FPFastMathModeShift_FPFastMathModeAllowReassocINTELShift:
        ...
        impl root::spv::Decoration {
            pub const DecorationPerVertexNV: root::spv::Decoration =
                Decoration::DecorationPerVertexKHR;
        }
        impl root::spv::Decoration {
        ...
        impl root::spv::BuiltIn {
            pub const BuiltInBaryCoordNV: root::spv::BuiltIn = BuiltIn::BuiltInBaryCoordKHR;
        }
        impl root::spv::BuiltIn {
            pub const BuiltInBaryCoordNoPerspNV: root::spv::BuiltIn =
                BuiltIn::BuiltInBaryCoordNoPerspKHR;
        }
        impl root::spv::BuiltIn {
        ...
        pub const FunctionControlShift_FunctionControlConstShift: root::spv::FunctionControlShift =
            3;
        pub const FunctionControlShift_FunctionControlOptNoneINTELShift:
        ...
        pub const MemoryAccessShift_MemoryAccessNonPrivatePointerKHRShift:
            root::spv::MemoryAccessShift = 5;
        pub const MemoryAccessShift_MemoryAccessAliasScopeINTELMaskShift:
            root::spv::MemoryAccessShift = 16;
        ...
        pub const Capability_CapabilityUniformDecoration: root::spv::Capability = 71;
        ...
        pub const Capability_CapabilityWorkgroupMemoryExplicitLayoutKHR: root::spv::Capability =
            4428;
        pub const Capability_CapabilityWorkgroupMemoryExplicitLayout8BitAccessKHR:
            root::spv::Capability = 4429;
        pub const Capability_CapabilityWorkgroupMemoryExplicitLayout16BitAccessKHR:
            root::spv::Capability = 4430;
        ...
        pub const Capability_CapabilityMeshShadingEXT: root::spv::Capability = 5283;
        pub const Capability_CapabilityFragmentBarycentricKHR: root::spv::Capability = 5284;
        ...
        pub const Capability_CapabilityRayTracingMotionBlurNV: root::spv::Capability = 5341;
        ...
        pub const Capability_CapabilityFragmentShaderPixelInterlockEXT: root::spv::Capability =
            5378;
        pub const Capability_CapabilityDemoteToHelperInvocation: root::spv::Capability = 5379;
        pub const Capability_CapabilityDemoteToHelperInvocationEXT: root::spv::Capability = 5379;
        pub const Capability_CapabilityBindlessTextureNV: root::spv::Capability = 5390;
        ...
        pub const Capability_CapabilityRoundToInfinityINTEL: root::spv::Capability = 5582;
        pub const Capability_CapabilityFloatingPointModeINTEL: root::spv::Capability = 5583;
        ...
        pub const Capability_CapabilityAsmINTEL: root::spv::Capability = 5606;
        pub const Capability_CapabilityAtomicFloat32MinMaxEXT: root::spv::Capability = 5612;
        pub const Capability_CapabilityAtomicFloat64MinMaxEXT: root::spv::Capability = 5613;
        pub const Capability_CapabilityAtomicFloat16MinMaxEXT: root::spv::Capability = 5616;
        pub const Capability_CapabilityVectorComputeINTEL: root::spv::Capability = 5617;
        pub const Capability_CapabilityVectorAnyINTEL: root::spv::Capability = 5619;
        pub const Capability_CapabilityExpectAssumeKHR: root::spv::Capability = 5629;
        ...
        pub const Capability_CapabilityVariableLengthArrayINTEL: root::spv::Capability = 5817;
        pub const Capability_CapabilityFunctionFloatControlINTEL: root::spv::Capability = 5821;
        pub const Capability_CapabilityFPGAMemoryAttributesINTEL: root::spv::Capability = 5824;
        pub const Capability_CapabilityFPFastMathModeINTEL: root::spv::Capability = 5837;
        pub const Capability_CapabilityArbitraryPrecisionIntegersINTEL: root::spv::Capability =
            5844;
        pub const Capability_CapabilityArbitraryPrecisionFloatingPointINTEL: root::spv::Capability =
            5845;
        ...
        pub const Capability_CapabilityFPGAMemoryAccessesINTEL: root::spv::Capability = 5898;
        pub const Capability_CapabilityFPGAClusterAttributesINTEL: root::spv::Capability = 5904;
        pub const Capability_CapabilityLoopFuseINTEL: root::spv::Capability = 5906;
        pub const Capability_CapabilityMemoryAccessAliasingINTEL: root::spv::Capability = 5910;
        pub const Capability_CapabilityFPGABufferLocationINTEL: root::spv::Capability = 5920;
        pub const Capability_CapabilityArbitraryPrecisionFixedPointINTEL: root::spv::Capability =
            5922;
        pub const Capability_CapabilityUSMStorageClassesINTEL: root::spv::Capability = 5935;
        pub const Capability_CapabilityIOPipesINTEL: root::spv::Capability = 5943;
        ...
        pub const Capability_CapabilityDotProductInputAll: root::spv::Capability = 6016;
        pub const Capability_CapabilityDotProductInputAllKHR: root::spv::Capability = 6016;
        pub const Capability_CapabilityDotProductInput4x8Bit: root::spv::Capability = 6017;
        pub const Capability_CapabilityDotProductInput4x8BitKHR: root::spv::Capability = 6017;
        pub const Capability_CapabilityDotProductInput4x8BitPacked: root::spv::Capability = 6018;
        pub const Capability_CapabilityDotProductInput4x8BitPackedKHR: root::spv::Capability = 6018;
        pub const Capability_CapabilityDotProduct: root::spv::Capability = 6019;
        pub const Capability_CapabilityDotProductKHR: root::spv::Capability = 6019;
        pub const Capability_CapabilityRayCullMaskKHR: root::spv::Capability = 6020;
        pub const Capability_CapabilityBitInstructions: root::spv::Capability = 6025;
        pub const Capability_CapabilityGroupNonUniformRotateKHR: root::spv::Capability = 6026;
        ...
        pub const Capability_CapabilityLongConstantCompositeINTEL: root::spv::Capability = 6089;
        pub const Capability_CapabilityOptNoneINTEL: root::spv::Capability = 6094;
        pub const Capability_CapabilityAtomicFloat16AddEXT: root::spv::Capability = 6095;
        pub const Capability_CapabilityDebugInfoModuleINTEL: root::spv::Capability = 6114;
        ...
        pub const QuantizationModes_QuantizationModesRND_ZERO: root::spv::QuantizationModes = 3;
        pub const QuantizationModes_QuantizationModesRND_INF: root::spv::QuantizationModes = 4;
        pub const QuantizationModes_QuantizationModesRND_MIN_INF: root::spv::QuantizationModes = 5;
        ...
        pub const Op_OpGroupNonUniformRotateKHR: root::spv::Op = 4431;
        ...
        pub const Op_OpSDot: root::spv::Op = 4450;
        pub const Op_OpSDotKHR: root::spv::Op = 4450;
        pub const Op_OpUDot: root::spv::Op = 4451;
        pub const Op_OpUDotKHR: root::spv::Op = 4451;
        pub const Op_OpSUDot: root::spv::Op = 4452;
        pub const Op_OpSUDotKHR: root::spv::Op = 4452;
        pub const Op_OpSDotAccSat: root::spv::Op = 4453;
        pub const Op_OpSDotAccSatKHR: root::spv::Op = 4453;
        pub const Op_OpUDotAccSat: root::spv::Op = 4454;
        pub const Op_OpUDotAccSatKHR: root::spv::Op = 4454;
        pub const Op_OpSUDotAccSat: root::spv::Op = 4455;
        pub const Op_OpSUDotAccSatKHR: root::spv::Op = 4455;
        ...
        pub const Op_OpEmitMeshTasksEXT: root::spv::Op = 5294;
        pub const Op_OpSetMeshOutputsEXT: root::spv::Op = 5295;
        ...
        pub const Op_OpTraceMotionNV: root::spv::Op = 5338;
        pub const Op_OpTraceRayMotionNV: root::spv::Op = 5339;
        ...
        pub const Op_OpDemoteToHelperInvocation: root::spv::Op = 5380;
        pub const Op_OpDemoteToHelperInvocationEXT: root::spv::Op = 5380;
        pub const Op_OpIsHelperInvocationEXT: root::spv::Op = 5381;
        pub const Op_OpConvertUToImageNV: root::spv::Op = 5391;
        pub const Op_OpConvertUToSamplerNV: root::spv::Op = 5392;
        pub const Op_OpConvertImageToUNV: root::spv::Op = 5393;
        pub const Op_OpConvertSamplerToUNV: root::spv::Op = 5394;
        pub const Op_OpConvertUToSampledImageNV: root::spv::Op = 5395;
        pub const Op_OpConvertSampledImageToUNV: root::spv::Op = 5396;
        pub const Op_OpSamplerImageAddressingModeNV: root::spv::Op = 5397;
        ...
        pub const Op_OpConstantFunctionPointerINTEL: root::spv::Op = 5600;
        pub const Op_OpFunctionPointerCallINTEL: root::spv::Op = 5601;
        pub const Op_OpAsmTargetINTEL: root::spv::Op = 5609;
        pub const Op_OpAsmINTEL: root::spv::Op = 5610;
        pub const Op_OpAsmCallINTEL: root::spv::Op = 5611;
        pub const Op_OpAtomicFMinEXT: root::spv::Op = 5614;
        pub const Op_OpAtomicFMaxEXT: root::spv::Op = 5615;
        pub const Op_OpAssumeTrueKHR: root::spv::Op = 5630;
        pub const Op_OpExpectKHR: root::spv::Op = 5631;
        ...
        pub const Op_OpVariableLengthArrayINTEL: root::spv::Op = 5818;
        pub const Op_OpSaveMemoryINTEL: root::spv::Op = 5819;
        pub const Op_OpRestoreMemoryINTEL: root::spv::Op = 5820;
        pub const Op_OpArbitraryFloatSinCosPiINTEL: root::spv::Op = 5840;
        pub const Op_OpArbitraryFloatCastINTEL: root::spv::Op = 5841;
        pub const Op_OpArbitraryFloatCastFromIntINTEL: root::spv::Op = 5842;
        pub const Op_OpArbitraryFloatCastToIntINTEL: root::spv::Op = 5843;
        pub const Op_OpArbitraryFloatAddINTEL: root::spv::Op = 5846;
        pub const Op_OpArbitraryFloatSubINTEL: root::spv::Op = 5847;
        pub const Op_OpArbitraryFloatMulINTEL: root::spv::Op = 5848;
        pub const Op_OpArbitraryFloatDivINTEL: root::spv::Op = 5849;
        pub const Op_OpArbitraryFloatGTINTEL: root::spv::Op = 5850;
        pub const Op_OpArbitraryFloatGEINTEL: root::spv::Op = 5851;
        pub const Op_OpArbitraryFloatLTINTEL: root::spv::Op = 5852;
        pub const Op_OpArbitraryFloatLEINTEL: root::spv::Op = 5853;
        pub const Op_OpArbitraryFloatEQINTEL: root::spv::Op = 5854;
        pub const Op_OpArbitraryFloatRecipINTEL: root::spv::Op = 5855;
        pub const Op_OpArbitraryFloatRSqrtINTEL: root::spv::Op = 5856;
        pub const Op_OpArbitraryFloatCbrtINTEL: root::spv::Op = 5857;
        pub const Op_OpArbitraryFloatHypotINTEL: root::spv::Op = 5858;
        pub const Op_OpArbitraryFloatSqrtINTEL: root::spv::Op = 5859;
        pub const Op_OpArbitraryFloatLogINTEL: root::spv::Op = 5860;
        pub const Op_OpArbitraryFloatLog2INTEL: root::spv::Op = 5861;
        pub const Op_OpArbitraryFloatLog10INTEL: root::spv::Op = 5862;
        pub const Op_OpArbitraryFloatLog1pINTEL: root::spv::Op = 5863;
        pub const Op_OpArbitraryFloatExpINTEL: root::spv::Op = 5864;
        pub const Op_OpArbitraryFloatExp2INTEL: root::spv::Op = 5865;
        pub const Op_OpArbitraryFloatExp10INTEL: root::spv::Op = 5866;
        pub const Op_OpArbitraryFloatExpm1INTEL: root::spv::Op = 5867;
        pub const Op_OpArbitraryFloatSinINTEL: root::spv::Op = 5868;
        pub const Op_OpArbitraryFloatCosINTEL: root::spv::Op = 5869;
        pub const Op_OpArbitraryFloatSinCosINTEL: root::spv::Op = 5870;
        pub const Op_OpArbitraryFloatSinPiINTEL: root::spv::Op = 5871;
        pub const Op_OpArbitraryFloatCosPiINTEL: root::spv::Op = 5872;
        pub const Op_OpArbitraryFloatASinINTEL: root::spv::Op = 5873;
        pub const Op_OpArbitraryFloatASinPiINTEL: root::spv::Op = 5874;
        pub const Op_OpArbitraryFloatACosINTEL: root::spv::Op = 5875;
        pub const Op_OpArbitraryFloatACosPiINTEL: root::spv::Op = 5876;
        pub const Op_OpArbitraryFloatATanINTEL: root::spv::Op = 5877;
        pub const Op_OpArbitraryFloatATanPiINTEL: root::spv::Op = 5878;
        pub const Op_OpArbitraryFloatATan2INTEL: root::spv::Op = 5879;
        pub const Op_OpArbitraryFloatPowINTEL: root::spv::Op = 5880;
        pub const Op_OpArbitraryFloatPowRINTEL: root::spv::Op = 5881;
        pub const Op_OpArbitraryFloatPowNINTEL: root::spv::Op = 5882;
        pub const Op_OpLoopControlINTEL: root::spv::Op = 5887;
        pub const Op_OpAliasDomainDeclINTEL: root::spv::Op = 5911;
        pub const Op_OpAliasScopeDeclINTEL: root::spv::Op = 5912;
        pub const Op_OpAliasScopeListDeclINTEL: root::spv::Op = 5913;
        pub const Op_OpFixedSqrtINTEL: root::spv::Op = 5923;
        pub const Op_OpFixedRecipINTEL: root::spv::Op = 5924;
        pub const Op_OpFixedRsqrtINTEL: root::spv::Op = 5925;
        pub const Op_OpFixedSinINTEL: root::spv::Op = 5926;
        pub const Op_OpFixedCosINTEL: root::spv::Op = 5927;
        pub const Op_OpFixedSinCosINTEL: root::spv::Op = 5928;
        pub const Op_OpFixedSinPiINTEL: root::spv::Op = 5929;
        pub const Op_OpFixedCosPiINTEL: root::spv::Op = 5930;
        pub const Op_OpFixedSinCosPiINTEL: root::spv::Op = 5931;
        pub const Op_OpFixedLogINTEL: root::spv::Op = 5932;
        pub const Op_OpFixedExpINTEL: root::spv::Op = 5933;
        pub const Op_OpPtrCastToCrossWorkgroupINTEL: root::spv::Op = 5934;
        pub const Op_OpCrossWorkgroupCastToPtrINTEL: root::spv::Op = 5938;
        ...
        pub const Op_OpTypeBufferSurfaceINTEL: root::spv::Op = 6086;
        pub const Op_OpTypeStructContinuedINTEL: root::spv::Op = 6090;
        pub const Op_OpConstantCompositeContinuedINTEL: root::spv::Op = 6091;
        pub const Op_OpSpecConstantCompositeContinuedINTEL: root::spv::Op = 6092;
        pub const Op_OpControlBarrierArriveINTEL: root::spv::Op = 6142;
        pub const Op_OpControlBarrierWaitINTEL: root::spv::Op = 6143;
        pub const Op_OpGroupIMulKHR: root::spv::Op = 6401;
        pub const Op_OpGroupFMulKHR: root::spv::Op = 6402;
        pub const Op_OpGroupBitwiseAndKHR: root::spv::Op = 6403;
        pub const Op_OpGroupBitwiseOrKHR: root::spv::Op = 6404;
        pub const Op_OpGroupBitwiseXorKHR: root::spv::Op = 6405;
        pub const Op_OpGroupLogicalAndKHR: root::spv::Op = 6406;
    ...
    pub mod spirv_cross {
        ...
        impl root::spirv_cross::MSLShaderVariableFormat {
            pub const MSL_VERTEX_FORMAT_OTHER: root::spirv_cross::MSLShaderVariableFormat =
                MSLShaderVariableFormat::MSL_SHADER_VARIABLE_FORMAT_OTHER;
        }
        impl root::spirv_cross::MSLShaderVariableFormat {
            pub const MSL_VERTEX_FORMAT_UINT8: root::spirv_cross::MSLShaderVariableFormat =
                MSLShaderVariableFormat::MSL_SHADER_VARIABLE_FORMAT_UINT8;
        }
        impl root::spirv_cross::MSLShaderVariableFormat {
            pub const MSL_VERTEX_FORMAT_UINT16: root::spirv_cross::MSLShaderVariableFormat =
                MSLShaderVariableFormat::MSL_SHADER_VARIABLE_FORMAT_UINT16;
        }
        impl root::spirv_cross::MSLShaderVariableFormat {
        ...
        impl root::spirv_cross::MSLShaderVariableFormat {
            pub const MSL_SHADER_INPUT_FORMAT_ANY16: root::spirv_cross::MSLShaderVariableFormat =
                MSLShaderVariableFormat::MSL_SHADER_VARIABLE_FORMAT_ANY16;
        }
        impl root::spirv_cross::MSLShaderVariableFormat {
            pub const MSL_SHADER_INPUT_FORMAT_ANY32: root::spirv_cross::MSLShaderVariableFormat =
                MSLShaderVariableFormat::MSL_SHADER_VARIABLE_FORMAT_ANY32;
        }
        #[repr(u32)]
        #[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
    ...
    pub struct ScShaderResources {
        ...
        pub gl_plain_uniforms: root::ScResourceArray,
